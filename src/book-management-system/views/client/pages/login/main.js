...
if (forgotPasswordForm) {
    forgotPasswordForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            // Gửi yêu cầu tới API
            const response = await fetch('http://localhost:3001/api/client/forgot-password', {
                method: 'POST',
                headers: {
...
otpSubmitBtn.addEventListener('click', async (e) => {
    ...
    try {
        const response = await fetch('http://localhost:3001/api/client/verify-otp', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
if (resetPasswordForm) {
    ...
    resetPasswordForm.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:3001/api/client/reset-password', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
